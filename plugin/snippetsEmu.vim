...
" Last Change: Wednesday 6th September 2006
" Version:     0.6
"
...
function! <SID>SetCom(text)
  ...
  if 1 "exists('syntax_on')
    " only set this up if the user has syntax highlighting on.
    ...
    " Thanks to the multiselect plugin for showin how to do this 
